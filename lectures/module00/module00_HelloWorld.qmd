...
- Dr. Rebecca Deek - [rdeek@pitt.edu](mailto:rdeek@pitt.edu) 
  - Office hours: [TBD]{style="color:red;"} (Until 10/2/2026) & by appointment.
- Dr. Soumik Purkayastha - [soumik@pitt.edu](mailto:soumik@pitt.edu)
  - Office hours: [TBD]{style="color:red;"} (From 10/5/2026) & by appointment.
...
![](_figs/01_data-science-infog.png){fig-alt="Steps of a data science project. Figure from R for Data Science ."}
...
:::{.column width="50%"}
![](_figs/02_MIT-news-AI-coding.png){fig-alt="Screenshot of MIT news article titled 'Can AI really code?'." height="400" fig-align=center}
:::
...
![](_figs/03_vibe-coding.png){fig-alt="Decorative. Vibe coding meme" height="350" fig-align=center}
...
![](_figs/04_rstudio-screenshot.png){.fragment .fade-in fig-alt="Screenshot of RStudio IDE with editor, console, and output labeled." width=100%}
:::
...
:::: {.columns}
:::{.column width="50%"}
![](_figs/05a_file-naming-meme.png){fig-alt="Decorative. XKCD meme with poorly named file scheme."}
:::

:::{.column width="50%"}
![](_figs/05b_file-organization-meme.png){fig-alt="Decorative. Meme with poorly named folder structure."}
:::
::::
...
:::{.column width="33%"}
![Don't do this (please).](_figs/06a-poor-file-organization){fig-alt="Screenshot of poor file naming system" fig-align=center}
:::

:::{.column width="33%"}
![A better file naming system.](_figs/06b_file-organization-research.png){fig-alt="Screenshot of an informative file naming system" fig-align=center}
:::

:::{.column width="33%"}
![A better file naming system (for these slides).](_figs/06c_file-organization-PUBHLT0411-m0.png){fig-alt="Screenshot of file names for this module!" fig-align=center}
:::
...
![](_figs/07_comment-code-meme.png){fig-alt="Decorative. Meme regarding poorly commented code." width="400" fig-align=center}
...
- Keeping all the files associated with a given project (data, R scripts, results, figures, etc.) in one directory is a wise and common practice.
  - RStudio has R projects that help with this.
    ...
    - Facilitate the use of relative paths like `data/dataFileName.csv`.
...
## Objects in R
![](_figs/08_rScreenshot-calculator.png){fig-alt="Screenshot of code from prior slide showing that no objects were saved to the environment. Code was written in a Markdown file and ran in the console." fig-align=center}
...
![](_figs/09_rScreenshot-naming-objects.png){fig-alt="Screenshot of above code showing that two objects are now saved to the environment. Code was written in a Markdown file and ran in the console." width=90% fig-align=center}
...
![](_figs/10_rScreenshot-character-object.png){fig-alt="Screenshot of above code showing that a new charcater object is now saved to the environment. Code was written in a Markdown file and ran in the console. The environment view has switch from list to grid" fig-align=center}
...
![](_figs/11_clean-slate.png){fig-alt="RStudio Global Options with a blue box around Workspace showing to save workspace never." height=4.5in fig-align=center}
...
:::{.column width="50%"}
![](_figs/12_mean-help-file.png){fig-alt="R help documentation for the 'mean()' function."}
:::
...
![](_figs/13_hello-world-meme.png){fig-alt="Decorative." fig-align=center}
